...
export interface IVendorShopServiceInterface{
 ...
 updateVendor(id:string,workingDays:string,data:IVendor):Promise<boolean|void>;
  ...
  getVendorsData (data:{search?:string,page?:string,limit?:string,lat?:number,lng?:number,distance?:number}):Promise<{data:VendorDto[],pagination: IPaginationResponseMeta}>
