...
exports.AddStaffSchema = joi_1.default.object({
    ...
    breaks: joi_1.default.array()
        .items(joi_1.default.object({
        breakStartTime: joi_1.default.string()
            .required()
            .custom((value, helpers) => {
        ...
        breakEndTime: joi_1.default.string()
            .required()
            .custom((value, helpers) => {
